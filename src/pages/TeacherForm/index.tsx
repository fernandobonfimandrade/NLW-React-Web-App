    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader 
                ...
                description="Oprimeiro passo é preencher o formulário de inscrição"
            />
            ...
            <main>
                <form onSubmit={handleCreateClass} >
                    <fieldset>
                        ...
                        <Input type="text" name="avatar" label="Avatar" placeholder="(comece com http://)" 
                            value={avatar} 
                            onChange={(e) => {setAvatar(e.target.value)}} />
                        <Input type="text" name="whatsapp" label="Whatsapp" placeholder="(somente números)" 
                            value={whatsapp} 
                    ...
                    <fieldset>
                        ...
                        />
                        <Input type="number" name="cost" label="Custo da sua hora/aula" 
                            value={cost}
